...
EGIT_REPO_URI="git://github.com/audacious-media-player/audacious-plugins.git"
...
src_configure() {
	...
	PKG_CONFIG_PATH=/usr/$(get_libdir)/pkgconfig econf \
		${ffmpeg} \
		--enable-modplug \
		--disable-soxr \
		--enable-neon \
